        ...
        try {
            ...
            await connection.execute(
                `INSERT INTO tZonesTotal (
                    ...
                    zone_FreshAir, zone_ExhaustAir, ExhaustFlag, zone_DehumidCfm,
                ...
                [
                    ...
                    totals.zone_ExhaustAir ?? 0,               // 7
                    totals.ExhaustFlag,                        // 8
                    totals.zone_DehumidCfm ?? 0,               // 9
                    totals.zone_Rem_Water_Vapour ?? 0,         // 10
                    totals.zone_HumidCfm ?? 0,                 // 11
                    totals.zone_add_Water_Vapour ?? 0,         // 12
                    totals.zone_ResultCfm_Hot ?? 0,            // 13
                    totals.zone_Room_Term_Supply_Mod ?? 0,     // 14
                    totals.zone_Room_Heating_Load_TR ?? 0,     // 15
                    totals.zone_Cfm_Heating_Load_TR ?? 0,      // 16
                    totals.zone_Result_Heating_Load_TR ?? 0,   // 17
                    totals.zone_ResultCfm ?? 0,                // 18
                    totals.zone_Room_Termi_Supply_Mod ?? 0,    // 19
                    totals.zone_Room_AC_Load_TR ?? 0,          // 20
                    totals.zone_Cfm_AC_Load_TR ?? 0,           // 21
                    totals.zone_Res_Cooling_Load_TR ?? 0,      // 22
                    totals.user_id ?? null,                    // 23
