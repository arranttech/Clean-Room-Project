const footerDesign = {
    ...
    title: "text-[40px] font-bold tracking-tight text-white sm:text-[32px] mb-2",
    subtitle:"mt-0 text-[16px] leading-relaxed text-slate-300 max-w-[900px] mx-auto",
    ...
    cardTitle: "text-[14px] font-medium text-white",
    contactText: "mt-8 text-[14px] text-slate-400 text-center",
    contactLink: "font-semibold text-white underline decoration-slate-500 hover:text-white transition-colors"
};
