const headerStyles = {
  ...
  headerInner: "mx-auto max-w-auto px-4 sm:px-8 lg:px-14 h-auto min-h-[64px] py-3 flex items-center justify-between gap-2",
  ...
  right: "flex items-center gap-2 sm:gap-3 flex-shrink-0",
  logout: "inline-flex items-center gap-1 sm:gap-2 text-slate-600 text-xs sm:text-sm font-medium px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg border border-slate-200 hover:bg-slate-100 hover:text-slate-900 transition",
};
