...
const S = {
  ...
  logoWrap:
    `h-[44px] w-[44px] md:h-[56px] md:w-[56px] ${theme.roundMd} flex items-center justify-center overflow-hidden flex-shrink-0`,
  ...
  title:
    `text-[16px] md:text-[20px] ${theme.weightBold} text-[#0F172A] whitespace-nowrap flex-shrink-0`,

  /* ── CENTER — hidden on mobile ── */
  center: `hidden md:flex flex-1 justify-center gap-8 lg:gap-[64px]`,
  navLink:
    `text-[15px] lg:text-[18px] ${theme.weightBold} text-[#0F172A] hover:text-[#475569] ${theme.transitionColors} no-underline whitespace-nowrap`,

  /* ── RIGHT ── */
  right: `flex items-center gap-2 md:gap-3 flex-shrink-0`,

  admin:
    `text-[14px] md:text-[16px] ${theme.weightSemibold} text-white bg-[${theme.accent}] hover:bg-[${theme.accentHover}] px-3 py-[6px] rounded-md ${theme.transitionColors} no-underline whitespace-nowrap`,

  divider: `text-${theme.textPrimary} select-none hidden md:block`,

  signIn:
    `hidden md:block text-[16px] md:text-[20px] ${theme.weightBold} text-[#0F172A] hover:text-[#475569] px-2 py-2 ${theme.transitionColors} no-underline whitespace-nowrap`,
  ...
  mobileLink:
    `text-[16px] ${theme.weightBold} text-[#0F172A] hover:text-[#475569] ${theme.transitionColors} py-2 border-b border-slate-100 last:border-0`,
  mobileSignIn:
    `text-[16px] ${theme.weightBold} text-[#0F172A] hover:text-[#475569] ${theme.transitionColors} py-2`,
}
