const adminDesign = {
	...
	sidebarTitle:
		"text-[11px] font-extrabold text-black-800 tracking-widest uppercase px-5 mb-5",
	navItem:
		"flex items-center justify-between px-3 py-3 rounded-xl text-sm font-semibold text-slate-600 hover:bg-blue-50 hover:text-blue-700 transition-all cursor-pointer mb-1 w-full",
	navItemActive:
		"flex items-center justify-between px-3 py-3 rounded-xl text-sm font-bold bg-blue-600 text-white shadow-md mb-1 w-full",
	navItemLeft: "flex items-center gap-3",
	navIcon: "text-lg shrink-0",
	navLabel: "flex-1 text-left",
	navBadge:
		"text-xs font-bold bg-blue-100 text-blue-700 rounded-full px-2 py-0.5 min-w-[22px] text-center",
	navBadgeActive:
