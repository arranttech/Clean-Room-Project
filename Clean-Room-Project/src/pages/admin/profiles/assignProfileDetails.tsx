...
export default function AssignProfileDetails() {
    const [assignedProfiles, setAssignedProfiles] = useState<AssignedProfileToken[]>(initialAssignedProfiles);
    ...
    return (
        <div>
            ...
            <div className={s.panelHeader}>
                ...
                <button type="button" onClick={() => setShowAssignForm(true)} className={s.addBtn}>
