const profileDesign = {
    ...
    thActions: "px-5 py-4 text-right text-xs font-bold text-slate-700 tracking-wider",
    ...
    // --- Badges ---
    badgeActive: "px-2.5 py-1 text-[11px] font-bold rounded-md bg-green-100 text-green-700",
    badgeInProgress: "px-2.5 py-1 text-[11px] font-bold rounded-md bg-orange-100 text-orange-700",

    // --- Action Buttons Styling ---
    editBtn: "text-blue-500 hover:text-blue-700 transition-colors p-1.5 rounded-lg hover:bg-blue-50",
    ...
    assignCard: "bg-white rounded-2xl border border-slate-200 shadow-sm p-8 flex flex-col gap-6",
    assignGrid: "grid grid-cols-2 gap-8",
    assignCol: "border border-slate-200 rounded-xl overflow-hidden",
    assignHeader: "bg-slate-50 border-b border-slate-200 px-5 py-4 font-semibold text-slate-800 text-sm",
    assignList: "flex flex-col max-h-[400px] overflow-y-auto",
    assignListItem: "flex items-center gap-3 px-5 py-4 border-b border-slate-100 hover:bg-slate-50 cursor-pointer transition-colors last:border-0",
    assignRadio: "w-4 h-4 text-blue-600 bg-white border-slate-300 focus:ring-blue-500 focus:ring-2 cursor-pointer",
