const usersDesign = {
	...
	thActions:
		"px-5 py-3.5 text-right text-xs font-bold text-slate-400 uppercase tracking-wider",
	...
	userEditIcon:
		"text-slate-400 hover:text-blue-600 transition-colors p-1.5 rounded-lg hover:bg-blue-500",
	...
	formTextarea:
		"w-full border border-slate-200 rounded-xl text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-y px-2 py-2",
