const usersDesign = {
  ...
  panelTitle: "text-xl sm:text-2xl font-extrabold bg-gradient-to-r from-slate-900 to-slate-600 bg-clip-text text-transparent tracking-tight",
  addBtn: "flex items-center gap-2 bg-blue-800 text-white text-xs sm:text-sm font-semibold px-3 sm:px-5 py-2 sm:py-2.5 rounded-xl hover:bg-blue-700 transition-colors shadow-sm",

  filterWrap: "flex items-center gap-2 mb-4 flex-wrap",
  filterBtn: (active: boolean, type: string) => {
    const base = "px-3 sm:px-4 py-1.5 rounded-full text-xs font-semibold border transition-all";
  ...
  searchInput: "w-full border border-slate-200 rounded-xl bg-white pl-10 pr-4 py-2 sm:py-2.5 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all shadow-sm",
  ...
  thActions: "px-3 sm:px-5 py-3 sm:py-3.5 text-right text-xs font-bold text-slate-400 uppercase tracking-wider whitespace-nowrap",
  ...
  formTextarea: "w-full border border-slate-200 rounded-xl text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-y px-3 py-2",
  formDivider: "border-t border-slate-100 mt-4 sm:mt-6 pt-4 sm:pt-6",
  formFooter: "flex items-center justify-end gap-3 flex-wrap",
  formCancelBtn: "flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl border border-slate-200 text-xs sm:text-sm font-semibold text-slate-600 hover:bg-slate-50 transition-all",
  formSubmitBtn: "flex items-center gap-2 bg-blue-600 text-white text-xs sm:text-sm font-semibold px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl hover:bg-blue-700 transition-all shadow-sm",
  ...
  deleteCard: "relative z-10 bg-white rounded-2xl shadow-2xl px-5 sm:px-8 py-6 sm:py-7 flex flex-col items-center gap-4 w-full max-w-sm",
  ...
  deleteCancelBtn: "flex-1 flex items-center justify-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl border border-slate-200 text-xs sm:text-sm font-semibold text-slate-600 hover:bg-slate-50 transition-all",
  deleteConfirmBtn: "flex-1 flex items-center justify-center gap-2 bg-red-500 hover:bg-red-600 text-white text-xs sm:text-sm font-semibold px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl transition-all shadow-sm",
