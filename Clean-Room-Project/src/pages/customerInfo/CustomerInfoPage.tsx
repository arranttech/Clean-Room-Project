			...
			<div className={styles.gridContainer}>
				...
				<div className={styles.card}>
					<div className={styles.fieldGroup}>
						...
						{errors.name && (
							<p className="text-red-500 text-xs mt-[-14px]">{errors.name}</p>
						)}
						...
						{errors.phone && (
							<p className="text-red-500 text-xs mt-[-14px]">{errors.phone}</p>
						)}
						...
						{errors.address && (
							<p className="text-red-500 text-xs mt-[-14px]">{errors.address}</p>
						)}
						...
						{errors.email && (
							<p className="text-red-500 text-xs mt-[-14px]">{errors.email}</p>
						)}
						...
						{errors.notes && (
							<p className="text-red-500 text-xs mt-[-14px]">{errors.notes}</p>
						)}
					</div>
				</div>
				...
				<div className={styles.card}>
					...
					<div className={styles.rowGroup}>
						<div className={styles.fieldGroup + " w-full"}>
							...
							{errors.branch && (
								<p className="text-red-500 text-xs mt-[-14px]">{errors.branch}</p>
							)}
						</div>
						...
						<div className={styles.fieldGroup + " w-full"}>
							...
							{errors.project && (
								<p className="text-red-500 text-xs mt-[-14px]">{errors.project}</p>
							)}
						</div>
					</div>
