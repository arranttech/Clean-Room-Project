...
function CustomerInfo() {
  ...
  return true;
    ...
    const validateAddress = (address) =>
        /^.{1,50}$/.test(address)
            ? ""
            : "Address must be 1–50 characters";
            ...
            <div className={styles.gridContainer}>
                ...
                <div className={styles.card}>
                    <div className={styles.fieldGroup}>
                        <label className={styles.label}>Customer Name <span className="text-red-600">*</span></label>
                        ...
                        <label className={styles.label}>Customer Address <span className="text-red-600">*</span></label>
                ...
                <div className={styles.card}>
                    ...
                    <div className={styles.rowGroup}>
                        <div className={styles.fieldGroup + " w-full"}>
                            <label className={styles.label}>Unit/Branch <span className="text-red-600">*</span></label>
                        ...
                        <div className={styles.fieldGroup + " w-full"}>
                            <label className={styles.label}>Project Name <span className="text-red-600">*</span></label>
                    ...
                    {/* LOCATION */}
                    <div className={styles.fieldGroup}>
                        <label className={styles.label}>Location Selection <span className="text-red-600">*</span></label>
                                ...
                                {locationResults.map((place) => (
                                    ...
                                    >
                                        <div className={styles.locationResultText}>
                                            ...
                                            <br />
                                            <span className="text-[10px]"> <span className={styles.coordinates}> Lattitude:  </span> {place.lat}</span>
