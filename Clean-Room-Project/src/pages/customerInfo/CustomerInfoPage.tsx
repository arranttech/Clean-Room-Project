...
function CustomerInfo() {
	...
	const customerAddress = useAppSelector(
		(s: any) => s.customerInfo.customerAddress
	);
	const emailAddress = useAppSelector((s: any) => s.customerInfo.emailAddress);
	const additionalNotes = useAppSelector(
		(s: any) => s.customerInfo.additionalNotes
	);
	...
	const locationQuery = useAppSelector(
		(s: any) => s.customerInfo.locationQuery
	);
	const selectedLocation = useAppSelector(
		(s: any) => s.customerInfo.selectedLocation
	);
	...
	const relativeHumidityMin = useAppSelector(
		(s: any) => s.customerInfo.relativeHumidityMin
	);
	const relativeHumidityMax = useAppSelector(
		(s: any) => s.customerInfo.relativeHumidityMax
	);
