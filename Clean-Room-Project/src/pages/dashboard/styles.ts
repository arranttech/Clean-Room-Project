const dashboardDesign = {
	...
	backBtn: "inline-flex items-center gap-2 border border-slate-300 px-4 py-2 rounded-xl hover:bg-slate-100 shadow-sm bg-white text-[14px] font-medium",
	...
	badge: "inline-flex items-center rounded-full bg-slate-100 text-slate-700 px-3 py-1 text-[13px] font-semibold",
	...
	primaryBtn: "inline-flex items-center gap-2 bg-blue-700 text-white px-4 py-2 rounded-xl hover:bg-blue-800 shadow-sm text-[14px] font-medium",
	secondaryBtn: "inline-flex items-center gap-2 border border-slate-300 px-4 py-2 rounded-xl hover:bg-slate-100 shadow-sm bg-white text-[14px] font-medium",
	backBtn1: "mt-10 inline-flex items-center gap-2 border border-slate-300 px-4 py-2 rounded-xl hover:bg-slate-100 shadow-sm bg-white text-[14px] font-medium",
  };
