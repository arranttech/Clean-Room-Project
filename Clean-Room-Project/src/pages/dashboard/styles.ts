...
const dashboardDesign = {
  ...
  customerDropdownList: `absolute right-0 top-[calc(100%+8px)] z-50 bg-white border border-${theme.borderColor} ${theme.roundMd} ${theme.shadow2xl} min-w-[200px] sm:min-w-[220px] py-1 overflow-hidden`,
  customerDropdownItem: `w-full text-left px-4 py-3 text-sm ${theme.transitionColors} hover:bg-blue-50 flex items-center justify-between gap-3`,
  customerDropdownItemActive: `bg-blue-50 ${theme.weightSemibold} text-${theme.primaryText}`,
  customerDropdownItemInactive: `text-${theme.textSecondary}`,
