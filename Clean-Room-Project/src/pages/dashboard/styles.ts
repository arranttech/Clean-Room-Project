const dashboardDesign = {
  ...
  logout:
    "inline-flex items-center gap-2 text-slate-600 text-sm font-medium px-3 py-2 rounded-lg border border-slate-200 hover:bg-slate-100 hover:text-slate-900 transition",

  /* body */
  contentWrap: "pt-10 pb-10 px-4",
  container: "px-10 mx-auto max-w-7xl",
  ...
  listTitle:
    "text-2xl md:text-3xl font-extrabold text-slate-900 text-center -mt-12",
  badge:
