const dashboardDesign = {
	...
	metricCard: "bg-white rounded-xl border border-slate-200 shadow-sm p-5 flex items-center gap-4",
	metricIconWrap: "h-11 w-11 rounded-xl flex items-center justify-center flex-shrink-0",
	...
	projectPendingStage: "text-[16px] text-blue-700 font-bold bg-blue-100 inline-block px-3 py-1 rounded-[5px]",
	...
	actionCardBase: "rounded-xl border border-slate-200 p-5 flex gap-4 items-start transition shadow-sm hover:shadow-md bg-white",
	actionCardHover: "hover:bg-blue-50 hover:border-blue-600 hover:ring-1 hover:ring-blue-600",
	actionIconWrap: "h-10 w-10 rounded-xl flex items-center justify-center shadow-sm flex-shrink-0",
	...
	featuresCard: "mt-6 bg-white rounded-2xl border border-slate-200 shadow-sm p-6",
	...
	featureIconWrap: "h-14 w-14 rounded-2xl bg-blue-100 flex items-center justify-center",
	...
	countBadge: "absolute right-0 inline-flex items-center rounded-full border border-slate-200 bg-white shadow-sm px-4 py-1.5 text-[13px] font-semibold text-slate-700",
	...
	emptyIconWrap: "h-16 w-16 rounded-full bg-slate-100 flex items-center justify-center",
  
	// cards list — each card is white with blue border + subtle shadow
	cardsList: "mt-2 flex flex-col gap-6",

projectCard: "bg-white rounded-2xl border border-blue-200 shadow-md hover:shadow-lg transition-shadow px-10 py-8",
	// card header
	...
	badgeCompleted: "inline-flex items-center rounded-full bg-green-100 text-green-700 border border-green-200 px-4 py-1 text-[13px] font-medium",
	...
	primaryBtn: "inline-flex items-center gap-2 bg-blue-700 text-white px-5 py-2.5 rounded-xl hover:bg-blue-800 shadow-sm text-[14px] font-semibold transition-colors",
	secondaryBtn: "inline-flex items-center gap-2 border border-slate-300 bg-white text-slate-700 px-5 py-2.5 rounded-xl hover:bg-slate-50 shadow-sm text-[14px] font-semibold transition-colors",
  
	// divider
	divider: "mt-6 border-t border-slate-300",
	// info grid
	// infoGrid: "mt-6 grid grid-cols-4 gap-x-12 px-4",
	// kvWrap: "flex items-start gap-3 overflow-hidden",
	infoGrid: "mt-6 grid grid-cols-4 gap-x-10",
	kvWrap: "flex items-start gap-2 min-w-0",
	kvValue: "text-[15px] font-bold text-slate-900 mt-0.5 break-words",
	kvIcon: "mt-1 text-blue-600 text-[18px]",
	kvBody: "flex flex-col",
	kvLabel: "text-[12px] font-semibold text-blue-500 uppercase tracking-wide",
  
	// back button — centered
	backBtn1: "mt-10 inline-flex items-center gap-2 border border-slate-300 px-5 py-2.5 rounded-xl hover:bg-slate-100 shadow-sm bg-white text-[14px] font-medium transition-colors",
  };
