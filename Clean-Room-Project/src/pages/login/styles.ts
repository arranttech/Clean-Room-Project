const loginDesign = {
  wrapper: "min-h-screen p-4 flex flex-col justify-center items-center bg-gradient-to-br from-[#0c1a2e] via-[#0f2a4a] to-[#1a1a2e]",
  headerText: "text-center text-gray-600 text-sm mb-6",
  gridContainer: "grid grid-cols-1 md:grid-cols-1 gap-10 px-4 md:px-10",

  card: "bg-white rounded-xl px-6 py-8 pt-7 shadow-xl min-w-[500px] min-h-[600px]",
