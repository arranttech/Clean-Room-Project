...
function ProjectInfoPage() {
	...
	// --- Customer fields from router state (passed from CustomerInfoPage) ---
				...
				<div className={styles.rowGroup}>
					<div className={styles.fieldGroup + " w-full"}>
						...
						<input
							...
							onChange={(e) => {
								...
								dispatch(updateField({ field: "unitBranch", value }));
								setErrors((prev) => ({
									...prev,
					...
					<div className={styles.fieldGroup + " w-full"}>
						...
						<input
							...
							onChange={(e) => {
								const value = e.target.value;
								dispatch(updateField({ field: "projectName", value }));
								setErrors((prev) => ({
									...prev,
