...
import { getProjectExportData } from "../../backend/controller/projectController";
const t = resultsText;
    ...
    <>
      ...
      <div className={s.wrap}>
        <div className={s.card}>
          ...
          <div className={s.buttonRow}>
            <button
              ...
              onClick={() =>
                downloadProjectXLSX(
                  Number(projectId),
                  String(summary?.project_unique_id),
          ...
          <div>
            <div className={s.reportTitle}>What's included in the report:</div>
